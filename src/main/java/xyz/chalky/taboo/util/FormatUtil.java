...
public class FormatUtil {
    ...
    public static String formatTime(final long duration) {
        ...
        seconds %= 60L;
        return ((hours > 0L) ? (hours + ":") : "") + ((minutes < 10L) ? ("0" + minutes) : Long.valueOf(minutes)) + ":"
                + ((seconds < 10L) ? ("0" + seconds) : Long.valueOf(seconds));
    }
    ...
    public static String filter(final String input) {
        return input.replace("\u202e", "").replace("@everyone", "@\u0435veryone")
